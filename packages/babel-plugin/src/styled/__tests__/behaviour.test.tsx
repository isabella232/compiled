...
describe('styled component behaviour', () => {
  ...
  it.only('should conditionally apply CSS mixins', () => {
    const actual = transform(`
      import { styled, css } from '@compiled/react';
    ...
    expect(actual).toMatchInlineSnapshot(`
      "/* File generated by @compiled/babel-plugin v0.0.0 */import{forwardRef}from'react';import*as React from'react';import{ax,ix,CC,CS}from\\"@compiled/react/runtime\\";const _7=\\"._syaz11x8{color:black}\\";const _6=\\"._bfhk1x77{background-color:white}\\";const _5=\\"._syaz1x77{color:white}\\";const _4=\\"._bfhk11x8{background-color:black}\\";const _3=\\"._1wyb1ul9{font-size:30px}\\";const _2=\\"._1qs91fg1{hover:var(--_vkdoks)}\\";const _=\\"._syaz1viz{color:var(--_c4nccv)}\\";const dark=null;const light=null;const Component=forwardRef(({as:C=\\"div\\",style,isDark,...props},ref)=><CC>
            <CS>{[_,_2,_3,_4,_5,_6,_7]}</CS>
            <C{...props}style={{...style,\\"--_c4nccv\\":ix(isDark?dark:light),\\"--_vkdoks\\":ix([props=>props.hoverColor,{color:props=>props.isDark?dark:light}])}}ref={ref}className={ax([\\"_syaz1viz _1qs91fg1 _1wyb1ul9\\",props.isDark?\\"_bfhk11x8 _syaz1x77\\":\\"_bfhk1x77 _syaz11x8\\",props.className])}/>
          </CC>);if(process.env.NODE_ENV!=='production'){Component.displayName='Component';}"
    `);
